	...
	return (function(t) {
					...
					return (
						...
						(i.getCurrentSize = function() {
							return [
								i.img.width,
								Math.round(
									(i.img.width / i.img.naturalWidth) *
										i.img.naturalHeight
								)
							];
						}),
				...
				function e() {
					...
					return (
						...
						(i.positionBoxes = function() {
							var t =
									-parseFloat(i.options.handleStyles.width) /
										2 +
									"px",
								e =
									-parseFloat(i.options.handleStyles.height) /
										2 +
									"px";
							[
								{ left: t, top: e },
						...
						(i.addBox = function(t) {
							...
							Object.assign(e.style, i.options.handleStyles),
								(e.style.cursor = t),
								(e.style.width =
									i.options.handleStyles.width + "px"),
								(e.style.height =
									i.options.handleStyles.height + "px"),
								e.addEventListener(
									"mousedown",
									i.handleMousedown,
									!1
					...
					o(this, t),
						...
						(this.hideOverlay = function() {
							n.overlay &&
								...
								n.quill.root.removeEventListener(
									"input",
									n.checkImage
								),
								n.setUserSelect(""));
		...
		function(t, e, n) {
			function o(t) {
				...
				return (
					"function" == typeof n && n instanceof n && l.call(n) == p
				);
			}
			var r = n(5),
				i = n(23),
